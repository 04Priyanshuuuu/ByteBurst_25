...
st.set_page_config(page_title="Ava - AI Assistant", layout="wide")
...
<body>
    ...
    <div class="content">Ava - Your AI Assistant</div>
        <div class="listening">Ava is continuously listening....</div>
       <div class="mic">🎤</div>
</div>
